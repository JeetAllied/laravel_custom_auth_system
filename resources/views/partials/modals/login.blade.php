            ...
            <div class="modal-body">
                <div>
                    <form method="POST"  id="modal_login_form">
                        ...
                        @endif
                        <div><button type="submit" class="btn btn-primary mt-2">Submit</button>&nbsp; Don't have an account <a class="register-button" href="javascript:void(0)">sign up</a> here</div>
