    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <form method="POST" id="modal_registration_form">
                        @csrf
                        ...
                        @endif
                        <div><button type="submit" class="btn btn-primary mt-2">Submit</button>&nbsp; Already have an account <a class="login-button" href="javascript:void(0)">sign in</a> here</div>
                    </form>
                </div>
